...
public class HexMapGenerator : MonoBehaviour
{
    ...
    void CreateRegions()
    {
        ...
        int borderX = grid.xWrapping ? regionBorder : mapBorderX;
        int borderZ = grid.xWrapping ? regionBorder : mapBorderZ;
        MapRegion region;
        switch (regionCount)
        {
            default:
                ...
                region.zMin = borderZ;
                region.zMax = grid.cellCountZ - borderZ;
                regions.Add(region);
                break;
            case 2:
    ...
    [Range(5, 95)]
    public int landPercentage = 50; // Процент суши

    [Range(1, 5)]
    public int waterLevel = 3;

    [Range(0f, 1f)]
    public float highRiseProbability = 0.25f; // Вероятность изменить выосту ячейки больше чем на 1
    [Range(0f, 0.4f)]
    public float sinkProbability = 0.2f; // Вероятность уменьшить высоту ячейки
    ...
    [Range(0f, 1f)]
    public float startingMoisture = 0.1f; // Начальные уровень влажности
    [Range(0f, 1f)]
    public float evaporationFactor = 0.5f; // Коэффициент испарения
    [Range(0f, 1f)]
    public float precipitationFactor = 0.25f; // Коэффициент осадков
    [Range(0f, 1f)]
    public float runoffFactor = 0.25f; // Коэффициент стока осадков
    [Range(0f, 1f)]
    public float seepageFactor = 0.125f; // Коэффициент просачивания воды
    ...
    [Range(0f, 1f)]
    public float temperatureJitter = 0.1f; // Коэффициент колебания температуры
