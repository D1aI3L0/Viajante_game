...
public class UnitStatManager : MonoBehaviour
{
    ...
    public void ProcessEndOfTurn(BattleEntitySP unit)
    {
        if (unit == null)
            return;
        ...
        if (!unit.IsEnemy)
        {
            ProcessAllyRegeneration(unit as AllyBattleCharacterSP);
        }
        else
        {
            ProcessEnemyRegeneration(unit as EnemyBattleCharacterSP);
        }
    }

    public void ProcessEndOfTurn(BattleEntityMP unit)
    {
        if (unit == null)
            return;
        ...
        if (!unit.IsEnemy)
        {
            ProcessAllyRegeneration(unit as AllyBattleCharacterMP);
        }
        else
        {
            ProcessEnemyRegeneration(unit as EnemyBattleCharacterMP);
        }
    }
    ...
    private void ProcessAllyRegeneration(AllyBattleCharacterSP ally)
    {
        if (ally == null)
            return;
    ...
    private void ProcessAllyRegeneration(AllyBattleCharacterMP ally)
    {
        if (ally == null)
            return;
    ...
    private void ProcessEnemyRegeneration(EnemyBattleCharacterSP enemy)
    {
        if (enemy == null)
            return;
    ...
    private void ProcessEnemyRegeneration(EnemyBattleCharacterMP enemy)
    {
        if (enemy == null)
            return;
