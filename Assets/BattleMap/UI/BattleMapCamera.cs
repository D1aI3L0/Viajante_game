...
public class BattleMapCamera : MonoBehaviour
{
    ...
    void CalculateCameraBounds()
    {
        ...
        {
            innerDiameter = BattleMapManagerMP.innerDiameter;
            outerRadius = BattleMapManagerMP.outerRadius;
        }
        else
        {
            innerDiameter = BattleMapManagerSP.innerDiameter;
            outerRadius = BattleMapManagerSP.outerRadius;
        }
